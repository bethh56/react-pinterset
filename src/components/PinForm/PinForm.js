    ...
    return (
      <div className="PinForm">
        <form className="col-6 offset-3">
          ...
          { isEditing
            ? <button className="btn btn-primary m-1" onClick={this.updatePin}>Update Pin</button>
            : <button className="btn btn-warning m-1" onClick={this.savePin}>Save Pin</button>
          }
        </form>
      </div>
    );
